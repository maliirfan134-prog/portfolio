...
const ClientReviewCard = ( {image, role, name }: props ) => {
  return (
    <div className='m-2'>
        ...
        {"Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil, debitis iure tempore culpa exercitationem architecto mollitia at temporibus modi ducimus ipsa ad incidunt consectetur quae! Accusamus veniam aspernatur cum alias"}
        </p>
